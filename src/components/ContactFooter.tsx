...
const ContactFooter = () => (
  <footer id="contact" className="relative py-32 px-6 lg:px-16 grain">
    ...
    <div className="relative z-10 max-w-4xl mx-auto text-center">
      ...
      <motion.h2
        className="font-serif text-5xl lg:text-8xl text-foreground mb-8"
      ...
      >
        Available for editorial, commercial, and fine art commissions worldwide.
      </motion.p>
      <motion.a
      ...
      <div className="mt-24 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
        <span className="font-serif text-foreground tracking-widest text-sm">
          ELARA<span className="text-primary">.</span>
        </span>
        <div className="flex gap-8">
          {["Instagram", "Behance", "Vimeo"].map((s) => (
            <a key={s} href="#" className="font-sans-display text-xs text-muted-foreground hover:text-primary tracking-wider transition-colors duration-300">
              {s}
            </a>
          ))}
        </div>
