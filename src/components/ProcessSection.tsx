    ...
    <section id="about" ref={ref} className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-16 grain">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-start">
        <div className="lg:sticky lg:top-32">
          ...
          <motion.blockquote className="font-serif text-xl sm:text-2xl lg:text-3xl text-foreground/80 italic leading-relaxed mb-6 sm:mb-8 border-l-2 border-primary/30 pl-4 sm:pl-6"
          ...
          <motion.p className="font-body text-base sm:text-lg text-muted-foreground leading-relaxed"
